...
export const metadata = {
  title: "Book a Repair Quote | SC GAMES TRADING",
  description:
    "Request a gaming console repair quote from SC GAMES TRADING via WhatsApp or the quote form."
};
          ...
          <div>
            ...
            <div className="mt-8 rounded-[8px] border border-white/10 bg-panel/80 p-6">
              ...
              <p className="mt-2 leading-7 text-slate-300">
                Sungai Way / Selangor area, Malaysia. Replace this placeholder
                with your exact Google Maps embed when ready.
              </p>
