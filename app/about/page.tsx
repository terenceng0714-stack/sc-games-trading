...
export const metadata = {
  title: "About SC GAMES TRADING",
  description:
    "Learn about SC GAMES TRADING, a friendly gaming console repair business serving customers around Sungai Way and Selangor."
};
      ...
      <section className="px-4 pt-32 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl items-start gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <SectionHeader
            ...
            copy="SC GAMES TRADING is run with the kind of practical care customers remember: explain the problem clearly, quote fairly, and repair only what makes sense."
          />
          <div className="space-y-5 rounded-[8px] border border-white/10 bg-panel/80 p-6 text-lg leading-8 text-slate-300 shadow-purpleGlow">
            <p>
              The shop supports gamers around Sungai Way, Selangor and nearby
              Malaysia areas with console, handheld and controller repair
              services. Whether the issue is a damaged HDMI port, controller
              drift, a weak battery or a screen problem, the goal is to help
              customers understand the repair before committing.
            </p>
            <p>
            ...
            <p>
              At the heart of SC GAMES TRADING is a simple idea: games should
